...
function writeToFile(filename, data) {
    ...
    fs.writeFile(filename, genhtml(data), (err) =>
        err ? console.error(err) : console.log('-------\nSuccess! Your team index html file was generated to the "dist" file.\n------')
    );
}
...
function addEngineer(){
    ...
    .then((data)=>{
        ...
        console.log('-------\nAdded ' + addedEngineer.empName +' to the team!' + '\n-------')
        continueTeam();
...
function addIntern(){
    ...
    .then((data)=> {
        ...
        console.log('-------\nAdded ' + addedIntern.empName+' to the team!' + '\n-------')
        continueTeam();
        return addedIntern
    })
}
